 ...
 */
UCLASS()
class PROTOTYPING_API AEOSGameSession : public AGameSession
{
	GENERATED_BODY()
public:
	...
	void HandleRegisterPlayerCompleted(FName lSessionName, const TArray<FUniqueNetIdRef>& PlayerIds, bool bWasSuccesful);
	...
	void HandleUnregisterPlayerCompleted(FName lSessionName, const TArray<FUniqueNetIdRef>& PlayerIds, bool bWasSuccesful);
	...
	void HandleStartSessionCompleted(FName lSessionName, bool bWasSuccessful);
	...
	void HandleEndSessionCompleted(FName lSessionName, bool bWasSuccessful);
	...
	void HandleDestroySessionCompleted(FName lSessionName, bool bWasSuccessful);
