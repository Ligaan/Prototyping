...
#include "QuaternionsRotation.h"

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat UQuaternionsRotation::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void UQuaternionsRotation::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternionsRotation::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternionsRotation::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternionsRotation::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UQuaternionsRotation::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UQuaternionsRotation::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
    if (Actor)
    {
