...
#include "RotateMyActor.h"

void URotateMyActor::ChangeRotation(AActor *a, AActor *b)
{
   a->SetActorRotation(b->GetActorRotation().Quaternion());
}

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat URotateMyActor::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void URotateMyActor::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void URotateMyActor::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void URotateMyActor::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
    if (SceneComponent)
    {
...
void URotateMyActor::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void URotateMyActor::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void URotateMyActor::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
    if (Actor)
    {
